...
export function BudgetDiffTable({ itemDiffs }: BudgetDiffTableProps) {
  ...
  return (
    ...
    >
      {/* Filtros */}
      <div className="-mx-1 mb-6 flex gap-2 overflow-x-auto px-1 pb-1 sm:mx-0 sm:flex-wrap sm:px-0">
        <button
              ...
              <>
                ...
                >
                  ...
                  <TableCell className="text-right font-medium">
                    {item.budget1Price !== undefined
                      ? formatBRL(item.budget1Price)
                      : "-"}
                  </TableCell>
                  <TableCell className="text-right font-medium">
                    {item.budget2Price !== undefined
                      ? formatBRL(item.budget2Price)
                      : "-"}
                  </TableCell>
                        ...
                        <div className="flex flex-wrap gap-3 text-sm sm:gap-4">
                          ...
                          {item.unitWeight > 0 && (
                            <span className="text-gray-600 dark:text-gray-300">
                              Peso total Orç1:{" "}
                              {formatWeight(
                                item.unitWeight * (item.budget1Qty || 0),
                              )}
                              {" | "}
                              Peso total Orç2:{" "}
                              {formatWeight(
                                item.unitWeight * (item.budget2Qty || 0),
                              )}
                            </span>
                          )}
                        </div>
