...
export function BudgetComparisonSummaryCards({
  ...
  const getCheaperLabel = () => {
    ...
    return priceAnalysis.cheaperBudget === "budget1"
      ? "Orçamento 1 mais barato"
      : "Orçamento 2 mais barato";
  };

  const getCheaperColor = () => {
    if (priceAnalysis.cheaperBudget === "equal")
    ...
    <div className="grid min-w-0 grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
        ...
        <div className="space-y-3">
          ...
          <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
            <div className="flex min-w-0 items-center justify-between gap-3">
              ...
              <span
                className={`font-bold ${totalsDiff.total.diff > 0 ? "text-status-error" : totalsDiff.total.diff < 0 ? "text-green-main" : "text-gray-600"}`}
              >
                {totalsDiff.total.diff > 0 ? "+" : ""}
                {formatBRL(totalsDiff.total.diff)}
              </span>
            </div>
      ...
      <Card>
        ...
        <div className="space-y-2 text-sm">
          <div className="grid grid-cols-[minmax(0,1fr)_auto_auto] gap-2 border-b border-gray-200 pb-2 text-xs font-medium text-gray-500 dark:border-gray-700 dark:text-gray-400">
            <span></span>
          ...
          <div className="grid grid-cols-[minmax(0,1fr)_auto_auto] gap-2 border-t border-gray-200 pt-2 dark:border-gray-700">
