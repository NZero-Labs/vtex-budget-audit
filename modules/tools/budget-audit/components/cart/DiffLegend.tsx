    ...
    <Card title="Legenda">
      ...
      <div className="mt-6 pt-4 border-t border-grey-medium/20">
        <p className="text-sm text-[#575756] dark:text-white/80 leading-relaxed">
          <strong className="text-[#3c3c3b] dark:text-white">Nota:</strong> Os
          thresholds de criticidade podem ser configurados via variáveis de
          ambiente. Por padrão, diferenças acima de 0.5% ou R$ 50,00 são
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="leading-relaxed">
        <span className="font-semibold text-[#3c3c3b] dark:text-white">
          {label}:
        </span>
        <span className="text-[#575756] dark:text-white/80 ml-1">
          {description}
        </span>
      </div>
    </div>
