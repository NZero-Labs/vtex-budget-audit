      ...
      <Card>
        <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <h3 className="text-lg font-bold text-brand-black dark:text-white sm:text-xl">
        ...
        {summary.totalDiffs > 0 && (
          <div className="mt-5 flex flex-wrap gap-3 border-t border-grey-medium/20 pt-5 sm:gap-6">
